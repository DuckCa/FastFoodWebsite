...
namespace FF_Fastfood.Controllers
{
    public class AdminController : Controller
    {
        ...
        public String addSelecFood()
        {
            ...
            {
                html = "<option value='0'>--All type--</option>";
        ...
        public ActionResult UpdateFood(Food food)
        {
            ...
            a.image_url = "~/images/" + food.image_url.ToString();
        ...
        public ActionResult Account(FilterAccount filter, int page = 1)
        {
            ...
            if (filter != null)
            {
                if (filter.role != null)
                {
                    ...
                    else if (filter.role.Equals("customer") || filter.role.Equals("deliverer"))
                    {
                        lst = lst.Where(x => x.role == filter.role).ToList();
                    }
                    else
                    {
                        lst = lst.Where(x => x.role != "customer" && x.role != "deliverer").ToList();
                    }
        ...
        public String addSelecRole(String acc)
        {
            ...
            if (acc == null)
            {
                ...
                html += "<option value='deliverer'>--delivery--</option>";
            ...
            else
            {
                ...
                else if (acc.Equals("deliverer"))
                {
                    html += "<option value='customer' >--customer--</option>";
                    html += "<option value='employee'>--employee--</option>";
                    html += "<option value='deliverer'selected>--delivery--</option>";
                }
        ...
        public ActionResult Chartcontrol(int? FilterType)
        {
            FillChartData fillChartData = new FillChartData();
